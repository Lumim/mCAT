...
final List<String> practiceImageAssets; // e.g., ['assets/images/face_1.png', 'assets/images/face_2.png']
final VoidCallback onPracticeDone;
const FaceTaskPracticeScreen({super.key, required this.practiceImageAssets, required this.onPracticeDone});
...
children: [
PrimaryButton(label: 'Next', onPressed: selected != null ? _next : null),
],
),
],
),
